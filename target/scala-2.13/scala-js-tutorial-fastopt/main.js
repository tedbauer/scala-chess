...
function $s_Lchess_web_Web__main__AT__V(args) {
  $m_Lchess_web_Web$().main__AT__V(args)
}
/** @constructor */
function $c_Lchess_web_Web$() {
  /*<skip>*/
}
$c_Lchess_web_Web$.prototype = new $h_O();
$c_Lchess_web_Web$.prototype.constructor = $c_Lchess_web_Web$;
/** @constructor */
function $h_Lchess_web_Web$() {
  /*<skip>*/
}
$h_Lchess_web_Web$.prototype = $c_Lchess_web_Web$.prototype;
$c_Lchess_web_Web$.prototype.main__AT__V = (function(args) {
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().addEventListener("DOMContentLoaded", ((arg1$2) => {
    $m_Lchess_web_Web$().setupUI__V()
  }))
});
$c_Lchess_web_Web$.prototype.appendPar__Lorg_scalajs_dom_raw_Node__T__V = (function(targetNode, text) {
  var parNode = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().createElement("p");
  parNode.textContent = text;
  targetNode.appendChild(parNode)
});
$c_Lchess_web_Web$.prototype.addClickedMessage__V = (function() {
  this.appendPar__Lorg_scalajs_dom_raw_Node__T__V($m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().body, "Hellloo")
});
$c_Lchess_web_Web$.prototype.setupUI__V = (function() {
  ...
  button.addEventListener("click", ((arg1$2) => {
    $m_Lchess_web_Web$().addClickedMessage__V()
  }));
...
var $d_Lchess_web_Web$ = new $TypeData().initClass({
  Lchess_web_Web$: 0
}, false, "chess.web.Web$", {
  Lchess_web_Web$: 1,
  O: 1
});
$c_Lchess_web_Web$.prototype.$classData = $d_Lchess_web_Web$;
var $n_Lchess_web_Web$;
function $m_Lchess_web_Web$() {
  if ((!$n_Lchess_web_Web$)) {
    $n_Lchess_web_Web$ = new $c_Lchess_web_Web$()
  };
  return $n_Lchess_web_Web$
}
/** @constructor */
...
$L0 = new $c_RTLong(0, 0);
$d_J.zero = $L0;
$s_Lchess_web_Web__main__AT__V(new ($d_T.getArrayOf().constr)([]));
}).call(this);
